...
declare namespace std {
     ...
     */
    function for_each<T, InputIterator extends base.Iterator<T>, Func extends (val: T) => any>(first: InputIterator, last: InputIterator, fn: Func): Func;
    /**
     * Apply function to range.
     *
     ...
     * @return first + n
     */
    function for_each_n<T, InputIterator extends base.Iterator<T>>(first: InputIterator, n: number, fn: (val: T) => any): InputIterator;
    /**
     ...
     */
    function all_of<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): boolean;
    /**
     ...
     */
    function any_of<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): boolean;
    /**
     ...
     *		   otherwise.
     */
    function none_of<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): boolean;
    /**
     ...
     */
    function equal<T, InputIterator extends base.Iterator<T>>(first1: InputIterator, last1: InputIterator, first2: base.Iterator<T>): boolean;
    /**
     * Test whether the elements in two ranges are equal.
     *
     * Compares the elements in the range [<i>first1</i>, <i>last1</i>) with those in the range beginning at
     ...
     *		   of the range starting at <i>first2</i>, and <code>false</code> otherwise.
     */
    function equal<T, InputIterator extends base.Iterator<T>>(first1: InputIterator, last1: InputIterator, first2: base.Iterator<T>, pred: (x: T, y: T) => boolean): boolean;
    /**
     ...
     */
    function find<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, val: T): InputIterator;
    /**
     ...
     *		   <i>last</i>.
     */
    function find_if<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): InputIterator;
    /**
     * Find element in range.
     *
     * Returns an iterator to the first element in the range [<i>first</i>, <i>last</i>) for which pred returns
     ...
     */
    function find_if_not<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): InputIterator;
    /**
     ...
     */
    function adjacent_find<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator): InputIterator;
    /**
     * Find equal adjacent elements in range.
     *
     * Searches the range [<i>first</i>, <i>last</i>) for the first occurrence of two consecutive elements that match,
     ...
     *		   [<i>first</i>, <i>last</i>). If no such pair is found, the function returns <i>last</i>.
     */
    function adjacent_find<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (x: T, y: T) => boolean): InputIterator;
    /**
     ...
     */
    function count<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, val: T): number;
    /**
     ...
     *			   object.
     */
    function count_if<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator, pred: (val: T) => boolean): number;
}
declare namespace std {
    /**
     ...
     */
    function copy<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator): OutputIterator;
    /**
     * Copy elements.
     *
     ...
     * @return An iterator to the end of the destination range where elements have been copied.
     */
    function copy_n<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, n: number, result: OutputIterator): OutputIterator;
    /**
     ...
     * @return An iterator to the end of the destination range where elements have been copied.
     */
    function copy_if<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, pred: (x: T) => boolean): OutputIterator;
    /**
     ...
     */
    function copy_backward<T, BidirectionalIterator1 extends base.Iterator<T>, BidirectionalIterator2 extends base.ILinearIterator<T>>(first: BidirectionalIterator1, last: BidirectionalIterator1, result: BidirectionalIterator2): BidirectionalIterator2;
    /**
     ...
     */
    function transform<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, op: (val: T) => T): OutputIterator;
    /**
     * Transform range.
     *
     ...
     * @return An iterator pointing to the element that follows the last element written in the <i>result</i> sequence.
     */
    function transform<T, InputIterator1 extends base.Iterator<T>, InputIterator2 extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, result: OutputIterator, binary_op: (x: T, y: T) => T): OutputIterator;
    /**
     ...
     */
    function unique_copy<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator): OutputIterator;
    /**
     * Copy range removing duplicates.
     *
     * Copies the elements in the range [<i>first</i>, <i>last</i>) to the range beginning at <i>result</i>, except
     ...
     * @return An iterator pointing to the end of the copied range, which contains no consecutive duplicates.
     */
    function unique_copy<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, pred: (x: T, y: T) => boolean): OutputIterator;
    /**
     ...
     */
    function remove_copy<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, val: T): OutputIterator;
    /**
     ...
     */
    function remove_copy_if<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, pred: (val: T) => boolean): OutputIterator;
    /**
     ...
     */
    function replace_copy<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, old_val: T, new_val: T): OutputIterator;
    /**
     * Copy range replacing value.
     *
     * Copies the elements in the range [<i>first</i>, <i>last</i>) to the range beginning at <i>result</i>, replacing
     ...
     * @return An iterator pointing to the element that follows the last element written in the result sequence.
     */
    function replace_copy_if<T, InputIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: InputIterator, last: InputIterator, result: OutputIterator, pred: (val: T) => boolean, new_val: T): OutputIterator;
    /**
     ...
     *		   order.
     */
    function reverse_copy<T, BidirectionalIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: BidirectionalIterator, last: BidirectionalIterator, result: OutputIterator): OutputIterator;
    /**
     ...
     */
    function rotate_copy<T, ForwardIterator extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first: ForwardIterator, middle: ForwardIterator, last: ForwardIterator, result: OutputIterator): OutputIterator;
    /**
...
declare namespace std {
     ...
     */
    function merge<T, InputIterator1 extends base.Iterator<T>, InputIterator2 extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, last2: InputIterator2, result: OutputIterator): OutputIterator;
    /**
     * Merge sorted ranges.
     *
     * Combines the elements in the sorted ranges [<i>first1</i>, <i>last1</i>) and [<i>first2</i>, <i>last2</i>), into
     ...
     * @return An iterator pointing to the past-the-end element in the resulting sequence.
     */
    function merge<T, InputIterator1 extends base.Iterator<T>, InputIterator2 extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, last2: InputIterator2, result: OutputIterator, compare: (x: T, y: T) => boolean): OutputIterator;
    /**
     ...
     */
    function set_union<T, InputIterator1 extends base.Iterator<T>, InputIterator2 extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, last2: InputIterator2, result: OutputIterator): OutputIterator;
    /**
     * Union of two sorted ranges.
     *
     * Constructs a sorted range beginning in the location pointed by <i>result</i> with the <i>set union</i> of the
     ...
     * @return An iterator to the end of the constructed range.
     */
    function set_union<T, InputIterator1 extends base.Iterator<T>, InputIterator2 extends base.Iterator<T>, OutputIterator extends base.ILinearIterator<T>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, last2: InputIterator2, result: OutputIterator, compare: (x: T, y: T) => boolean): OutputIterator;
    /**
...
declare namespace std.base {
    ...
    abstract class ArrayContainer<T, Source extends IArrayContainer<T>> extends Container<T> implements IArrayContainer<T> {
         ...
         * @inheritdoc
         */
        insert<U extends T, InputIterator extends Iterator<T>>(pos: ArrayIterator<T, Source>, first: InputIterator, last: InputIterator): ArrayIterator<T, Source>;
        /**
     * @inheritdoc
     */
         ...
         * @inheritdoc
         */
        insert<U extends T, InputIterator extends Iterator<T>>(pos: ArrayReverseIterator<T, Source>, first: InputIterator, last: InputIterator): ArrayIterator<T, Source>;
        /**
         * @hidden
         */
         ...
         * @hidden
         */
        protected abstract _Insert_by_range<InputIterator extends Iterator<T>>(pos: ArrayIterator<T, Source>, first: InputIterator, last: InputIterator): ArrayIterator<T, Source>;
        /**
         * @inheritdoc
         */
...
declare namespace std {
    ...
    class Vector<T> extends base.ArrayContainer<T, Vector<T>> {
         ...
         * @hidden
         */
        protected _Insert_by_range<InputIterator extends base.Iterator<T>>(position: VectorIterator<T>, first: InputIterator, last: InputIterator): VectorIterator<T>;
        /**
         * @inheritdoc
         */
        pop_back(): void;
...
declare namespace std {
    ...
    class Deque<T> extends base.ArrayContainer<T, Deque<T>> {
         ...
         * @hidden
         */
        protected _Insert_by_range<U extends T, InputIterator extends base.Iterator<U>>(pos: DequeIterator<T>, first: InputIterator, last: InputIterator): DequeIterator<T>;
        /**
         * @hidden
         */
...
declare namespace std {
    ...
    class List<T> extends base._ListContainer<T, ListIterator<T>> implements base.IDequeContainer<T> {
         ...
         * @return An iterator that points to the first of the newly inserted elements.
         */
        insert<U extends T, InputIterator extends base.Iterator<U>>(position: ListReverseIterator<T>, begin: InputIterator, end: InputIterator): ListReverseIterator<T>;
        /**
         * Erase an element.
         *
         * Removes from the {@link List} either a single element; <i>position</i>.
...
declare namespace std {
    ...
    class TreeSet<T> extends base.UniqueSet<T> implements base.ITreeSet<T> {
         ...
         * @param compare A binary predicate determines order of elements.
         */
        constructor(begin: base.Iterator<T>, end: base.Iterator<T>, compare: (x: T, y: T) => boolean);
        /**
         * @inheritdoc
         */
        clear(): void;
         ...
         * @hidden
         */
        protected _Insert_by_range<U extends T, InputIterator extends base.Iterator<U>>(first: InputIterator, last: InputIterator): void;
        /**
         * @hidden
         */
...
declare namespace std {
    ...
    class TreeMap<Key, T> extends base.UniqueMap<Key, T> implements base.ITreeMap<Key, T> {
         ...
         * @param end Input interator of the final position in a sequence.
         */
        constructor(begin: base.Iterator<Pair<Key, T>>, end: base.Iterator<Pair<Key, T>>);
        /**
         * Range Constructor.
         *
         * @param begin nput interator of the initial position in a sequence.
         ...
         * @param compare A binary predicate determines order of elements.
         */
        constructor(begin: base.Iterator<Pair<Key, T>>, end: base.Iterator<Pair<Key, T>>, compare: (x: Key, y: Key) => boolean);
        /**
         * @inheritdoc
         */
        clear(): void;
         ...
         * @hidden
         */
        protected _Insert_by_range<L extends Key, U extends T, InputIterator extends base.Iterator<Pair<L, U>>>(first: InputIterator, last: InputIterator): void;
        /**
         * @hidden
         */
...
declare namespace std {
     ...
     */
    function distance<T, InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator): number;
    /**
     * Advance iterator.
     *
     ...
     */
    function next<T, ForwardIterator extends base.Iterator<T>>(it: ForwardIterator, n?: number): ForwardIterator;
    /**
     ...
     */
    function begin<T>(container: base.Container<T>): base.Iterator<T>;
     ...
     */
    function end<T>(container: base.Container<T>): base.Iterator<T>;
